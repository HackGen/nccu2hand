...
role :web, "nccu2hand.com"                          # Your HTTP server, Apache/etc
role :app, "nccu2hand.com"                         # This may be the same as your `Web` server
role :db,  "nccu2hand.com"   , :primary => true # This is where Rails migrations will run
